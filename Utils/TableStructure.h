...
namespace Db 
{
	...
	struct TableStructure
	{
		...
		TABLE_STRUCTURE_API TableStructure(std::string table_name, std::list<Db::Column> columns);
		...
		TABLE_STRUCTURE_API const unsigned int get_column_index(const std::string& column_name) const;
