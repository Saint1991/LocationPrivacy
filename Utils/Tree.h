...
#include "RevisitDepthFirstIterator.h"
#include "RevisitDepthFirstConstIterator.h"

namespace Graph
{
	template <typename NODE, typename NODE_DATA, typename EDGE, typename EDGE_DATA = nullptr_t>
	class Tree
	{
	...
	public:
		...
		typedef BaseIterator<NODE, NODE_DATA, EDGE, EDGE_DATA> base_iterator;
		typedef BaseConstIterator<NODE, NODE_DATA, EDGE> base_const_iterator;
		typedef DepthFirstIterator<NODE, NODE_DATA, EDGE, EDGE_DATA> depth_first_iterator;
		typedef DepthFirstConstIterator<NODE, NODE_DATA, EDGE> depth_first_const_iterator;
		typedef BreadthFirstIterator<NODE, NODE_DATA, EDGE, EDGE_DATA> breadth_first_iterator;
		typedef BreadthFirstConstIterator<NODE, NODE_DATA, EDGE> breadth_first_const_iterator;
		typedef RevisitDepthFirstIterator<NODE, NODE_DATA, EDGE, EDGE_DATA> revisit_depth_first_iterator;
		typedef RevisitDepthFirstConstIterator<NODE, NODE_DATA, EDGE> revisit_depth_first_const_iterator;
		...
		friend class revisit_depth_first_iterator;
		friend class revisit_depth_first_const_iterator;
		#pragma endregion
