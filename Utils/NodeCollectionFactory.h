...
namespace Graph 
{
	...
	protected:
		...
		std::shared_ptr<Collection::IdentifiableCollection<std::shared_ptr<Node<NODE_DATA, EDGE_DATA>>>> node_collection;
		...
		bool add_node(std::shared_ptr<Graph::Node<NODE_DATA, EDGE_DATA>> node);
	...
	public:
		...
		std::shared_ptr<const Collection::IdentifiableCollection<std::shared_ptr<const Node<NODE_DATA, EDGE_DATA>>>> create_static_node_collection() const;
		std::shared_ptr<Collection::IdentifiableCollection<std::shared_ptr<Node<NODE_DATA, EDGE_DATA>>>> create_updateable_node_collection();
