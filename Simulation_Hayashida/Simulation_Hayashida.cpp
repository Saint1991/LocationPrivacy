...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	const Graph::Rectangle<Geography::LatLng> MAP_BOUNDARY(35.635, 139.675, 35.680, 139.720);//(35.625, 139.665, 35.690, 139.730)(35.600, 139.645, 35.710, 139.755)
	...
	std::unique_ptr<Simulation::ISimulator<Map::BasicDbMap, Entity::PauseMobileEntity<Geography::LatLng>, Entity::RevisablePauseMobileEntity<Geography::LatLng>, Requirement::KatoMethodRequirement, Geography::LatLng, Graph::RevisableTrajectory<Geography::LatLng>>> simulator
