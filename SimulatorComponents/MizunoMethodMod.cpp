...
namespace Method
{
	...
	{
		double score = 1 / std::pow(1 + reachable_entity_count, 2 * requirement->required_preference_conservation - 1);
		if (already_achieved_anonymous_area_size < setting_anonymous_area) score *= ar_size - setting_anonymous_area;
		return score;
	}
