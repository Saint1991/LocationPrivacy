#include "stdafx.h"
#include "SemanticCrossJudgementModule.h"
...
namespace Observer
{
	...
	/// コンストラクタ
	///</summary>
	SemanticCrossJudgementModule::SemanticCrossJudgementModule(
	...
	) : Evaluate::CrossJudgementModule<Map::BasicDbMap, Geography::LatLng, Graph::SemanticTrajectory<Geography::LatLng>, Entity::Dummy<Geography::LatLng>, User::BasicUser<Geography::LatLng>>(map, entities, move_speed, cross_rule)
	{
	}
	...
	///</summary>
	std::shared_ptr<ObservedTrajectoryStructure> SemanticCrossJudgementModule::create_observed_trajectory_structure() const
	{
