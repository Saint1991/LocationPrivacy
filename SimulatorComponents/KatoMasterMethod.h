...
namespace Method {
	...
	protected:
		...
		void update_user_plan(ChangeParameter check_parameter, int phase_id);
			void modification_of_user_trajectory_when_LONGER_PAUSE_TIME(int phase_id);//userの停止時間の修正
			void modification_of_user_trajectory_when_SHORTER_PAUSE_TIME(int phase_id);//userの停止時間の修正
			void modification_of_user_trajectory_when_PATH(int phase_id);//userの移動経路の修正
			void modification_of_user_trajectory_when_FASTER_SPEED(int phase_id);//userの行動速度の修正
			void modification_of_user_trajectory_when_SLOER_SPEED(int phase_id);//userの行動速度の修正
			void modification_of_user_trajectory_when_VISIT_POI(int phase_id);//userの停止地点の修正
